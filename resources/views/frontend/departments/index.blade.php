...
@section('content')
 ...
 <section class="fire_faq" style="margin-top: 7rem;">
                    ...
                    <div class="faq_tab_content">
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div id="depof_bba" role="tabpanel" class="tab-pane fade show active">
                                ...
                                <div class="tab_text">
                                    <p>The need for managers in business who can face the growing complexities and challenges is growing in the country. Business is now conducted in the context of growing globalization in a highly competitive word. In recognition of this need the Leading University has established the Department of Business Administration to provide education for future mangers in the fast changing word.</p>
                                    <p>The department is committed to education of young men and women with potential to meet the challenges of the modern time in business. The mission of the Department is to provide all round education to international standard so that they could face the emerging competitive world with ability and confidence. It aims at becoming a leading institution in providing best possible resources. Supporting facilities and expertise so as to impart first rate education to potential managers in business. The mission of the Department in short is to develop quality education programs for successful careers of its students.</p>
                                    <p>The Department of Business Administration is one of the founding and the largest Department of the University. It has about 2000 (Two thousand) students and 64 highly qualified extremely dedicated vastly experienced faculty members. Among them, 34 full time and 30 Adjunct faculty. The Department has also been hiring business executives from the corporate word to teach students real life cases.</p>
                                    <p>The Department offers 3 important degree Programs:</p>
                                    <ol style="padding: 5px 60px">
                                        <li>Bachelor of Business Administration (BBA) 126 credits.</li>
                                        <li>Master of Business Administration (MBA) 63 Credit</li>
                                        <li>Executive Master of Business Administration (EMBA) 51 Credits</li>
                                    </ol>
                                    <p>The Department offers 4 Majors in BBA and 4 Majors in MBA/EMBA Programs, those are Accounting and Information System (AIS), Human Resource Management (HRM), Finance and Banking (F&B), and Marketing (MKT). Research & teaching are the prime of objectives of this department. The curriculum encourages students to sharpen their analytical and communication skills, focus on building leadership abilities, which will allow future managers to operate effectively in an increasingly growing global and technologically advanced market place.</p>
                                    <p style="color: #000;"><strong>Degree Requirements (Bachelor in Business Administration) </strong></p>
                                    <p>Total course requirements for degree program are as follows:</p>
                                    <table>
                                        <tbody style="border:0, border-collapse: collapse;">
                                            <tr>
                                                <td style="padding: 15px 30px 15px 60px; width: 70%">General Education (G. Ed.) Courses</td>
                                                <td style="padding: 15px 5px; width: 30%" >15 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 30px 15px 60px;"">Core Courses</td>
                                                <td style="padding: 15px 5px;" >90 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 30px 15px 60px;">Advanced Courses</td>
                                                <td style="padding: 15px 5px;" >18 Credits</td>
                                            </tr>
                                              <tr>
                                                <td style="padding: 15px 30px 15px 60px;">Internship</td>
                                                <td style="padding: 15px 5px;" >3 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 30px 15px 60px;"><div align="right"><strong>Total</strong></div></td>
                                                <td style="padding: 15px 5px;"><strong>126 Credits</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <p>The BBA Program is designed to impart deeper understanding of business both from theoretical and practical standpoints. the program offers specialization of advanced studies in Finance & Accounting, Marketing and Management.</p>
                                    <p style="color: #000 ;"> <strong>Degree Requirements (Master in Business Administration-Regular)</strong>
                                        <br>
                                        Total course requirements for degree program are as follows:
                                    </p>
                                     <table>
                                        <tbody style="border:0; width: 100%;">
                                            <tr>
                                                <td style="padding: 15px 60px; width: 70%;">Foundation Coerces</td>
                                                <td style="padding: 15px 20px; width: 30%;" >24 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 60px;"">Core Courses</td>
                                                <td style="padding: 15px 20px;" >24 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 60px;">Advanced Courses</td>
                                                <td style="padding: 15px 20px;" >12 Credits</td>
                                            </tr>
                                              <tr>
                                                <td style="padding: 15px 60px;">Project work/Internship</td>
                                                <td style="padding: 15px 20px;" >3 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 60px; "><div align="right"><strong>Total</strong></div></td>
                                                <td style="padding: 15px 20px;"><strong>64 Credits</strong></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <p>
                                        The Regular MBA Program has been designed to provide students with an internationally recognized qualification which enables them to progress to senior management posts in business management and operations where specialized knowledge can be used.
                                    </p>
                                    <p style="color: #000;">
                                        <strong>Degree Requirements (Master in Business Administration-Executive)</strong>
                                        <br>
                                        Total course requirements for degree program are as follows:
                                    </p>
                                     <table>
                                        <tbody style="border:0; width: 100%;">
                                            <tr>
                                                <td style="padding: 15px 60px; width: 70%;">Core Courses</td>
                                                <td style="padding: 15px 20px; width: 30%;" >36 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 60px;"">Specialization Courses</td>
                                                <td style="padding: 15px 20px;" >12 Credits</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 15px 60px;">Project work/Internship</td>
                                             ...
                                             <tr>
                                                <td style="padding: 15px 60px; "><div align="right"><strong>Total</strong></div></td>
                                                <td style="padding: 15px 20px;"><strong>52 Credits</strong></td>
                                            </tr>
                                            
                                        </tbody>
                                    </table>

                                    <p>The Executive MBA Program has been designed to upgrade knowledge and skills of students to international standards. The aim of the program is to provide competence to cope with changes at home and challenges of the global market.</p>
                                </div>
                            </div>
                            ...
                            <div id="depof_thm" role="tabpanel" class="tab-pane fade">
                                ...
                                <div class="tab_text">
                                    ...
                                    <br>
                                    <strong>BTHM of LU overview:</strong>
                                    <br>
                                    ...
                                    <br>
                                    <strong>Industry Affiliation:</strong>
                                    <br>
    ...
    </section> <section class="fire_faq" style="margin-top: 7rem;">
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    <div class="faq_tab_menu clearfix">
